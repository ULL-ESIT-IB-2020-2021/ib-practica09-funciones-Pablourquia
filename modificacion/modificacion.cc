...
#include <vector>
#include <math.h>
#include "modificacion.funciones.h"
using namespace std;
...
int main (int argc,char *argv[]){
  ...
  cout << "hay " << Modification(vector_with_prime_numbers, parameter) << " numeros pares" << endl;
  cout << "hay " << (parameter - (Modification(vector_with_prime_numbers, parameter)) << " numeros impares" << endl;
  return 0;
}
